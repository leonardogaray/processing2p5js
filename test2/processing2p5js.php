...
function processing2p5js($containerName, $pde){
    ...
    $pFunctions = "/((resizeCanvas|sin|cos|endShape|vertex|bezierDetail|pop|push|rotate|textAlign|bezier|translate|random|beginShape|textSize|quad|strokeCap|point|colorMode|smooth|rectMode|line|circle|ellipseMode|fill|ellipse|createCanvas|background|noFill|stroke|noStroke|triangle|strokeWeight|text|rect|arc|radians|loadImage|image)(\s){0,}\()/";
    $pVars = "/(frameCount|BOTTOM|CLOSE|SQUARE|CORNERS|CORNER|ROUND|mouseX|mouseY|CENTER|TWO_PI|HALF_PI|PIE|PI|QUARTER|RGB|width|height|HSB)/";
