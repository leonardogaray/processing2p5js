...
try {
    ...
    $where = " ass.id IN (22) "; //Id from TP - moodle.mdl_assign
    ...
    foreach($result as $index => $row){
        ...
        $repo = preg_replace("/https\:\/\/github.com\/(\w+)\/(\w+)\/tree\/tp3/", '$1', $github);
        $project = preg_replace("/https\:\/\/github.com\/(\w+)\/(\w+)\/tree\/tp3/", '$2', $github);
