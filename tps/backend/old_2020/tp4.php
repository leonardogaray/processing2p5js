...
try {
    ...
    $where = " ass.id IN (34) "; //Id from TP - moodle.mdl_assign
    ...
    foreach($result as $index => $row){
        ...
        $repo = preg_replace("/https\:\/\/github.com\/(\w+)\/(\w+)\/tree\/tp4/", '$1', $github);
        $project = preg_replace("/https\:\/\/github.com\/(\w+)\/(\w+)\/tree\/tp4/", '$2', $github);
